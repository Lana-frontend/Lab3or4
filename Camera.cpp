...
#include "Camera.h" #include <iostream> #include <string> using namespace std;
Camera::Camera(){
...
} Camera::~Camera(){ } void Camera::Getproducer(){
    cout << "Name Camera: " << producer << endl; }
void Camera::Getvolume_memory(){ cout << "Volume memory: " << volume_memory << endl;
} void Camera::Getzoom_ratio(){
    cout << "Zoom ratio: " << zoom_ratio << endl; }
void Camera::GetminPrice(){ cout << "Min Price: " << minPrice << endl;
} void Camera::GetmaxPrice(){
    cout << "Max Price: " << maxPrice << endl; }
void Camera::Getnumber_of_purchases(){ cout << "Number of purchases: " << number_of_purchases << endl;
} void Camera::Getstreet_manufacture(){
    cout << "Street manufacture: " << street_manufacture << endl; cout << endl;
